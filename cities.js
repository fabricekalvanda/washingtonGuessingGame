//Fabrice Kalvanda
//Cities of Washington Guessing Game
//#####################################################################################################
...
*/
    ...
    var city = ["BELLEVUE", "BOTHELL", "DUVALL", "EDMONDS", "KENMORE", "KIRKLAND", "LAKE FOREST PARK", "LYNNWOOD", "MONROE", "MOUNTLAKE TERRACE", "REDMOND", "SEATTLE", "SHORELINE", "TACOMA", "WOODINVILLE", "EVERETT"];
//////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if (window.confirm("Do you want to start a new game?"))
        {
            ...
            window.form1.hint.value = "Enter your guess below and click Guess button!";
        }
